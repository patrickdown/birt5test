...
namespace TiltFive
{
    ...
    public sealed class Glasses : Singleton<Glasses>
    {
        ...
        private class GlassesCore : TrackableCore<GlassesSettings>
        {
            ...
            protected override bool TryGetPoseFromPlugin(out Pose pose, GlassesSettings settings)
            {
                ...
                Vector3 posOfUGLS_UGBD = new Vector3(
                    glassesPose.PosOfGLS_GBD.x,
                    glassesPose.PosOfGLS_GBD.z,
                    glassesPose.PosOfGLS_GBD.y);
            ...
            protected override void SetDrivenObjectTransform(GlassesSettings settings)
            {
                ...
                settings.headPoseCamera?.transform.SetPositionAndRotation(
                    pose_UnityWorldSpace.position,
                    pose_UnityWorldSpace.rotation);
            }
        }
    }
}
